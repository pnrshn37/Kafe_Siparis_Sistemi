...
menu = {
    "1": {
        ...
        "urunler": {
          ...
          "14": ("Demleme Çay", 75.00, "siyah-cay.jpg", "Demli, klasik Türk çayı"),
          "15": ("Fincan Çay", 100.00, "fincancay.jpg", "Hafif içimli, fincanda servis edilen çay"),
          "16": ("Bitki Çayları", 85.00, "bitki-cayi.jpg", "Rahatlatıcı, doğal bitki aromaları"),
          "17": ("Meyve Aromalı Fincan Çay", 100.00, "meyvearomalı.jpg", "Meyve aromalarıyla zenginleştirilmiş çay"),
          "18": ("Chai Tea Latte", 90.00, "chai-tea-latte.jpg", "Baharatlı, sütlü ve aromatik çay"),
          "19": ("Salep", 90.00, "salep.jpg", "Tarçın eşliğinde, sıcak ve geleneksel kış içeceği")
    ...
    "2": {
        ...
        "ikon": "🍃",
        "alt_baslik": "Doğadan Gelen Huzur",
        "urunler": {
